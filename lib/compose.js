...
// Platform yang link-nya memang berguna kalau disisipkan ke teks post.
// Pinterest memakainya sebagai tujuan pin; YouTube & Facebook menampilkannya
// sebagai tautan yang bisa diklik. TikTok & Instagram sengaja tidak — di sana
// link tidak bisa diklik dan cuma jadi sampah teks.
...
function composePostText({ platform, title = '', caption = '', hashtags = [], link = '' }) {
  ...
  if (LINK_PLATFORMS.includes(platform) && link.trim()) parts.push(link.trim());
...
module.exports = { composePostText, lengthWarning, HASHTAG_PLATFORMS, TITLED_PLATFORMS, LINK_PLATFORMS, LIMITS };
